...
Environment Variables:
    ...
    GRAPHITI_ANTHROPIC_MODEL: Model for LLM (default: claude-sonnet-4-6)
...
class GraphitiConfig:
    ...
    openrouter_llm_model: str = "anthropic/claude-sonnet-4-6"
    ...
    def from_env(cls) -> "GraphitiConfig":
        ...
        anthropic_model = os.environ.get(
            "GRAPHITI_ANTHROPIC_MODEL", "claude-sonnet-4-6"
        )
        ...
        openrouter_llm_model = os.environ.get(
            "OPENROUTER_LLM_MODEL", "anthropic/claude-sonnet-4-6"
        )
